                    ...
                    <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end" className="w-80 p-0">
                            ...
                            <div className="divide-y divide-slate-100">
                                {[
                                    { title: 'New comment on Design Board', time: '5 min ago', unread: true },
                                    { title: 'Sarah shared a board with you', time: '1 hour ago', unread: true },
                                    { title: 'Your export is ready', time: '2 hours ago', unread: true },
                                ].map((notification, i) => (
                                    <button 
                                        key={i} 
                                        className={cn(
