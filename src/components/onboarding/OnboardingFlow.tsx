...
const features = [
  {
    ...
    description:
      "Unlimited space to express your ideas with a powerful drawing experience",
  ...
  },
  {
    ...
    description:
      "Work together with your team simultaneously in shared workspaces",
  ...
  },
  {
    ...
    description:
      "Smart assistance that understands context and accelerates your workflow",
  ...
  return (
    <div className="fixed inset-0 z-50 bg-gradient-to-br from-primary-50 via-white to-accent-50 flex items-center justify-center p-4 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div
          className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-accent-200/30 rounded-full blur-3xl animate-pulse"
          ...
          {steps.map((s, i) => (
            <div key={s} className="flex items-center">
              <div className="relative">
                ...
                >
                  {currentStepIndex > i ? <Check className="w-5 h-5" /> : i + 1}
                </div>
                <span
                  className={cn(
              ...
              {i < 3 && (
                <div
                  className={cn(
                    ...
                    currentStepIndex > i ? "bg-primary-500" : "bg-slate-200",
                  )}
                />
              )}
            </div>
