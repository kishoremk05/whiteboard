...
export function CTA() {
    ...
    return (
        <section className="py-24 lg:py-32 bg-gray-900 relative overflow-hidden">
            ...
            {/* Floating elements */}
            <div className="absolute top-20 left-10 w-20 h-20 bg-yellow-400 rounded-xl transform rotate-12 opacity-80 shadow-2xl" />
            <div className="absolute bottom-20 right-10 w-16 h-16 bg-pink-400 rounded-full opacity-80 shadow-2xl" />
            <div className="absolute top-1/2 right-20 w-12 h-12 bg-blue-400 rounded-lg transform -rotate-6 opacity-60" />
            <div className="absolute bottom-1/3 left-16 w-10 h-10 bg-green-400 rounded-full opacity-60" />
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
                ...
                <h2 className="text-4xl sm:text-5xl lg:text-6xl font-black text-white mb-6 leading-tight">
                    ...
                    <span className="relative inline-block">
                        ...
                        <svg className="absolute -bottom-2 left-0 w-full" viewBox="0 0 120 12" fill="none">
                            <path d="M2 8 Q 30 2, 60 8 Q 90 14, 118 6" stroke="#FBBF24" strokeWidth="4" strokeLinecap="round" fill="none" />
                        </svg>
                    </span>
                    {' '}to life?
                </h2>
                ...
                <p className="text-lg lg:text-xl text-gray-400 mb-10 max-w-2xl mx-auto">
                    Join thousands of creative teams using CanvasBoard to visualize, collaborate, and create together.
                </p>
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                    ...
                    <Button
                        ...
                        size="lg"
                        className="w-full sm:w-auto border-2 border-white/30 text-white hover:bg-white/10 rounded-full px-10 py-7 text-lg font-medium backdrop-blur-sm"
                    >
                        Request a Demo
                    </Button>
                </div>
