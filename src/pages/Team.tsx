          ...
          <div className="relative z-10 flex flex-col items-center justify-center min-h-[60vh]">
            <div className="max-w-md text-center">
              ...
              <p className="text-gray-500 mb-8">
                Create an organization to start inviting team members and
                collaborating on boards together.
              </p>
              <Button
              ...
              <Card className="border-blue-200 bg-blue-50/50 shadow-sm">
                <CardHeader className="border-b border-blue-100">
                  ...
                  <CardDescription className="text-blue-700">
                    You have {receivedInvitations.length} pending invitation
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-sm text-slate-600">
                            Invited by {invitation.inviterName || "Team Admin"}{" "}
                            as{" "}
            ...
            <CardHeader className="border-b border-slate-100">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                  ...
                  <CardDescription>
                    {currentOrganization?.name || "Your organization"} has{" "}
