...
import { ArrowLeft, Share, Download, MoreHorizontal, Star, Check, FileText, UserPlus } from 'lucide-react';
...
import { fetchCollaborators, type CollaboratorWithUser } from '../lib/services/collaboratorService';
        ...
        <div className="min-h-screen flex flex-col bg-slate-100">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                            ...
                            >
                                <Check className={cn('w-4 h-4 mr-2', pageFormat !== 'blank' && 'invisible')} />
                                Blank Page
                            </DropdownMenuItem>
                            <DropdownMenuItem 
                            ...
                            >
                                <Check className={cn('w-4 h-4 mr-2', pageFormat !== 'ruled' && 'invisible')} />
                                Ruled Lines
                            </DropdownMenuItem>
                        </DropdownMenuContent>
                    </DropdownMenu>
                            ...
                            {collaborators.slice(0, 3).map((collab) => (
                                <Avatar key={collab.id} className="w-8 h-8 ring-2 ring-white">
                                    <AvatarFallback className="bg-gradient-to-br from-blue-500 to-purple-600 text-white text-xs font-semibold">
                                        {getInitials(collab.user_profile?.name || collab.email || 'U')}
                                    </AvatarFallback>
                                </Avatar>
                            ))}
            ...
            <main className="flex-1 relative bg-white">
                <div 
                    ...
                    style={{
                        backgroundImage: pageFormat === 'ruled' 
