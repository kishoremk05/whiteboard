    ...
    return (
        <DashboardLayout>
            ...
            >
                                ...
                                <div className="grid sm:grid-cols-2 gap-4">
                                    ...
                                    <div className="space-y-2">
                                        <Label htmlFor="email" className="text-slate-700">
                                            Email
                                            <span className="ml-1 text-xs text-slate-400">(verified)</span>
                                        </Label>
                ...
                {/* Preferences Tab */}
                <TabsContent value="preferences" className="animate-in fade-in-0 slide-in-from-bottom-2 duration-300">
                    <div className="grid gap-6 max-w-2xl">
                        <Card className="border-slate-200 shadow-sm">
                            <CardHeader>
                                <CardTitle className="flex items-center gap-2">
                                    ...
                                    <div className="grid grid-cols-3 gap-3">
                                        {themeOptions.map((option) => (
                                            ...
                                            >
                                                ...
                                                <span className={cn(
                                                    'text-sm font-medium',
                                                    theme === option.value ? 'text-primary-700' : 'text-slate-600'
                                                )}>
                                                    {option.label}
                                                </span>
                                            </button>
                ...
                {/* Notifications Tab */}
                <TabsContent value="notifications" className="animate-in fade-in-0 slide-in-from-bottom-2 duration-300">
                    <div className="grid gap-6 max-w-2xl">
                        <Card className="border-slate-200 shadow-sm">
                            <CardHeader>
                                <CardTitle className="flex items-center gap-2">
                        ...
                        <Card className="border-slate-200 shadow-sm">
                            ...
                            <CardContent>
                                <div className="flex items-center justify-between p-4 rounded-xl bg-slate-50">
                                    <div>
                                        <p className="font-medium text-slate-900">Enable Push Notifications</p>
                                        <p className="text-sm text-slate-500">
                ...
                {/* Billing Tab */}
                <TabsContent value="billing" className="animate-in fade-in-0 slide-in-from-bottom-2 duration-300">
                    <div className="grid gap-6 max-w-2xl">
                        <Card className="border-slate-200 shadow-sm overflow-hidden">
                                ...
                                <div className="flex items-center justify-between p-4 rounded-xl bg-emerald-50 border border-emerald-200">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-slate-500">Current session • Last active now</p>
                                        </div>
                                    </div>
